...
//			{
//				// HERE
//				if (TransformUtils.ClosestTo(_entity.gameObject, _entity.foodToEat, _entity.waterToDrink) == _entity.waterToDrink)
...
//				else if (TransformUtils.CheckIfClose(_entity.transform, _entity.foodToEat.transform, 0.5f)) // HERE
//				{
